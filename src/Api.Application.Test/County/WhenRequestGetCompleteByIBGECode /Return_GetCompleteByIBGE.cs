...
{
    public class Return_GetCompleteByIBGE
    {
        private CountiesController _controller;

        [Fact]
        public async Task WhenGetCompleteByIBGEOnCountiesController()
        {
            ...
            Assert.True(_getCompleteByIBGEResult is OkObjectResult);
        }
    }
}
